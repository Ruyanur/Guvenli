...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $term = $_POST['term'] ?? '';
    $sql = "SELECT * FROM products WHERE urun_adi LIKE '%$term%'";
...
<body>
    <div class="container">
        <h2>Ürün Ara</h2>
        <li><a href="satinal.php">urun al</a></li>
        <li><a href="anasayfa.php">>GERİ DÖN<</a></li>
        <form id="searchForm">
    ...
    <script>
                        ...
                        products.forEach(product => {
                            output += `
                                <tr>
                                    ...
                                    <td><button onclick="satınAl(${product.id})">Satın Al</button></td> <!-- Satın Al butonu -->
                                </tr>`;
                        });
                    } else {
        ...
        function satınAl(urun_id) {
            window.location.href = 'sat.php?urun_id=' + urun_id; // Satın al sayfasına yönlendirme
        }
    </script>
</body>
</html>
